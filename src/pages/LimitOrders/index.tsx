...
import LimitOrdersHeader from 'components/LimitOrders/LimitOrdersHeader'
...
export default function LimitOrders({ history }: RouteComponentProps) {
  ...
  return (
    <>
      ...
      <NetworkAlert />
      <AppBody>
        <LimitOrdersHeader isSell={isSell} toggleOrderType={toggleOrderType} />
        <Wrapper id="limit-orders-page">
          <ConfirmSwapModal
            isOpen={showConfirm}
            trade={trade}
